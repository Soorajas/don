...
FORCE_CHANNEL = os.environ.get("FORCE_CHANNEL", "AVACINEMAS_2021")
SAVE_USER = os.environ.get("SAVE_USER", "no").lower()
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "@Avacinemas_2021")
BOT_USERNAME = os.environ.get("BOT_USERNAME", "DONLEE_ROBOT")
DEV_NAME = os.environ.get("DEV_NAME", "Muhammed")
DEV_USERNAME = os.environ.get("DEV_USERNAME", "Thlalapathy66fanada")
...
GROUP_LINK = os.environ.get("GROUP_LINK", "t.me/orukadhasollatumasir")
CHANNEL_LINK = os.environ.get("CHANNEL_LINK", "t.me/AVACINEMAS_2021")
